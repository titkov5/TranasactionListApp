    ...
    public struct DailyTransactionsFeed: GraphQLSelectionSet {
      ...
      public struct AsTransactionWidget: GraphQLSelectionSet {
        ...
        public struct Transaction: GraphQLSelectionSet {
          ...
          public init(id: GraphQLID, title: String, amount: Amount, type: TransactionType) {
            self.init(unsafeResultMap: ["__typename": "Transaction", "id": id, "title": title, "amount": amount.resultMap, "type": type])
          }
